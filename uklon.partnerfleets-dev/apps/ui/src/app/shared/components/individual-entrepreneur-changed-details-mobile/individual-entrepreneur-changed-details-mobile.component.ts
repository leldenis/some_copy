...
@Component({
  selector: 'upf-individual-entrepreneur-changed-details-mobile',
  standalone: true,
  imports: [MatExpansionModule, MatIconModule, TranslateModule, MatDivider],
  templateUrl: './individual-entrepreneur-changed-details-mobile.component.html',
  styleUrls: ['./individual-entrepreneur-changed-details-mobile.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IndividualEntrepreneurChangedDetailsMobileComponent {
