...
import { VehicleActiveCommissionProgramsListComponent } from '@ui/modules/bonuses/components/vehicle-active-commission-programs-list/vehicle-active-commission-programs-list.component';
...
@Component({
  selector: 'upf-vehicle-active-commission-programs',
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
    ...
    VehicleActiveCommissionProgramsListComponent,
    ScrolledDirectiveModule,
    EmptyStateComponent,
  ],
  templateUrl: './vehicle-active-commission-programs.component.html',
  styleUrl: './vehicle-active-commission-programs.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class VehicleActiveCommissionProgramsComponent {
  public readonly fleetData = input.required<FleetDataDto>();

  public readonly filterKey = StorageFiltersKey.VEHICLE_ACTIVE_COMMISSION_PROGRAMS;
  ...
  private getActiveCommissionPrograms(filters: VehicleCommissionProgramsFiltersDto, loadMore = false): void {
    ...
    this.commissionProgramsService
      .getVehicleCommissionPrograms(queryParams, CommissionProgramType.ACTIVE)
      .pipe(
        tap(({ has_more_items }) => {
