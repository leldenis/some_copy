...
describe('Driver details trips tab', () => {
  beforeEach(() => {
    if (isMockingData()) {
  ...
  describe('Driver trips', () => {
    ...
    describe('Trips filters', () => {
      ...
      it('[5526] should have License plate filter', () => {
        cy.getBySel('trips-licensePlate-filter').should('exist');
      });

      it('[5526] should have Status filter', () => {
    ...
    if (isMockingData()) {
      describe.skip('Trips grid', () => {
        beforeEach(() => cy.useDateRangeFilter('custom', '01.05.2023', '31.05.2023'));

        it.skip('[PF-286] should have header row', () => {
