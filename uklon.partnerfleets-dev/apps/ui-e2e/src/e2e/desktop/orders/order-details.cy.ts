...
if (isMockingData()) {
  describe('Order details', () => {
    ...
    describe('Map', () => {
      it.skip('[PF-327] should display empty state while data is loading', () => {
      ...
      it.skip('[PF-328] should display map when data finished loading', () => {
        cy.intercept('api/fleets/orders/e098876173964b118f7088bde518a668', (req) => {
          req.continue(() => {
            cy.getBySel('trip-map').should('be.visible');
          });
      ...
      it.skip('[PF-329] should have route start and route end markers', () => {
    ...
    describe('Order details panel', () => {
      it.skip('[PF-330] should have order details panel', () => {
        cy.getBySel('order-details-panel').should('exist');
      });

      it.skip('[PF-331] should be opened by default', () => {
      ...
      it.skip('[PF-332] should toggle opened state on panel header click', () => {
      ...
      describe.skip('Order details panel header', () => {
        it.skip('[PF-333] should have panel toggle', () => {
          cy.getBySel('order-details-panel-toggle').should('exist');
        });

        it.skip('[PF-334] should have driver info', () => {
        ...
        it.skip('[PF-335] should have order statuts badge', () => {
          cy.getBySel('order-status').should('exist').should('contain', 'Виконано');
        });

        it.skip('[PF-336] should have driver avatar and full name navigating to driver page', () => {
      ...
      describe('Order details vehicle info', () => {
        it.skip('[PF-337] should have vehicle info', () => {
        ...
        it.skip('[PF-338] should have vehicle avatar and full name navigating to vehicle page', () => {
          ...
          cy.getBySel('vehicle-licensePlate')
            .should('exist')
            .should('have.attr', 'href')
            .should('contain', vehicleLink);
        });
      });

      describe('Order trip details', () => {
        it.skip('[PF-339] should have route points displayed', () => {
        ...
        it.skip('[PF-340] should have trip time info', () => {
        ...
        it.skip('[PF-341] should have trip info', () => {
        ...
        it.skip('[PF-342] should have product type badge', () => {
